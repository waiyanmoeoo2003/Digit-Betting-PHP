        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Special Datatable</h5>
                  <form action="">
                    <div class="row">
                      <div class="col-md-2">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        if(isset($_SESSION['update_id'])){
                          $special_id=$_SESSION['update_id'];
                          $all=$table->getWithId($special_id);
    ...
    <script>
      $(document).ready(function(){
        $(".target").change(function(){
          ...
          $("#load-table-date").load("load_special_table.php",{
            special_date : $('#mySelect').val()
          });
        })
      })
      $(document).ready(function(){
        $("#get_all").click(function(){
          special_date : $('#mySelect').val('Date');
          console.log('hello world');
          $("#load-table-date").load("load_special_table.php",{
        ...
        function delete_special($id){
          $.ajax({
            url:'../_actions/delete_special.php',
            type:'GET',
            data:{
              'special_id': $id
            },
